...
public class SaleEntryInfoApplicationSearchResDto implements IResServiceDto {
    ...
    private List<SaleEntryInfoApplicationPurchaseInfoSearchResDto> purchaseDtoList;
    ...
    public List<SaleEntryInfoApplicationPurchaseInfoSearchResDto> getPurchaseDtoList() {
        return purchaseDtoList;
    }

    public void setPurchaseDtoList(List<SaleEntryInfoApplicationPurchaseInfoSearchResDto> purchaseDtoList) {
