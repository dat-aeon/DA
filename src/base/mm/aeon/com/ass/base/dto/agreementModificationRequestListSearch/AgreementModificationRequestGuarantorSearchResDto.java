...
public class AgreementModificationRequestGuarantorSearchResDto implements IResServiceDto {
    ...
    public Integer getDaGuarantorId() {
        return daGuarantorId;
    }

    public void setDaGuarantorId(Integer daGuarantorId) {
        this.daGuarantorId = daGuarantorId;
    }
    ...
    public Integer getYearStay() {
        return yearStay;
    }

    public void setYearStay(Integer yearStay) {
