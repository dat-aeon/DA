...
public class SaleEntryInfoApplicationSearchReqDto implements IReqServiceDto {
    ...
    private Boolean saleEntryStatus;
    ...
    public Boolean getSaleEntryStatus() {
        return saleEntryStatus;
    }

    public void setSaleEntryStatus(Boolean saleEntryStatus) {
        this.saleEntryStatus = saleEntryStatus;
    }
