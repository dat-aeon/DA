...
public class SettlementIndexApplicationStatusUpdateService extends AbstractService
implements IService<SettlementIndexApplicationStatusUpdateReqBean, SettlementIndexApplicationStatusUpdateResBean> {

private ASSLogger logger = new ASSLogger();

@Override
public SettlementIndexApplicationStatusUpdateResBean execute(SettlementIndexApplicationStatusUpdateReqBean reqBean) {

SettlementIndexApplicationStatusUpdateResBean resBean = new SettlementIndexApplicationStatusUpdateResBean();
 
try {
    
    
        SettlementIndexApplicationStatusUpdateReqDto updateReqDto = new SettlementIndexApplicationStatusUpdateReqDto();
