...
public class AgentDocumentErrorApplicationStatusUpdateService extends AbstractService
        implements IService<AgentDocumentErrorApplicationStatusUpdateReqBean, AgentDocumentErrorApplicationStatusUpdateResBean> {

    private ASSLogger logger = new ASSLogger();

    @Override
    public AgentDocumentErrorApplicationStatusUpdateResBean execute(AgentDocumentErrorApplicationStatusUpdateReqBean reqBean) {

        AgentDocumentErrorApplicationStatusUpdateResBean resBean = new AgentDocumentErrorApplicationStatusUpdateResBean();
