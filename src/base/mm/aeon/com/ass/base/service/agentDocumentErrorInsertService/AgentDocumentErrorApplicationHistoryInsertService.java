 ...
 *************************************************************************/
package mm.aeon.com.ass.base.service.agentDocumentErrorInsertService;

import mm.aeon.com.ass.base.dto.saleClaimApplicationUpdate.SaleClaimApplicationHistoryInsertReqDto;
...
public class AgentDocumentErrorApplicationHistoryInsertService extends AbstractService implements
        IService<AgentDocumentErrorApplicationHistoryInsertServiceReqBean, AgentDocumentErrorApplicationHistoryInsertServiceResBean> {

    private ASSLogger logger = new ASSLogger();

    @Override
    public AgentDocumentErrorApplicationHistoryInsertServiceResBean execute(
            AgentDocumentErrorApplicationHistoryInsertServiceReqBean reqBean) {

        AgentDocumentErrorApplicationHistoryInsertServiceResBean resBean = new AgentDocumentErrorApplicationHistoryInsertServiceResBean();

        try {

            SaleClaimApplicationHistoryInsertReqDto insertReqDto = new SaleClaimApplicationHistoryInsertReqDto();
