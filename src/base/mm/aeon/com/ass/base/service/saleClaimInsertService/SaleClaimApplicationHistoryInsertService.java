...
public class SaleClaimApplicationHistoryInsertService extends AbstractService implements
        IService<SaleClaimApplicationHistoryInsertServiceReqBean, SaleClaimApplicationHistoryInsertServiceResBean> {

    private ASSLogger logger = new ASSLogger();

    @Override
    public SaleClaimApplicationHistoryInsertServiceResBean execute(
            SaleClaimApplicationHistoryInsertServiceReqBean reqBean) {

        SaleClaimApplicationHistoryInsertServiceResBean resBean = new SaleClaimApplicationHistoryInsertServiceResBean();
