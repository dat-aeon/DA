 ...
 *************************************************************************/
package mm.aeon.com.ass.base.service.agentAndProductInsertService;

import mm.aeon.com.ass.base.dto.agentAndProductApplicationUpdate.AgentAndProductApplicationHistoryInsertReqDto;
...
public class AgentAndProductApplicationHistoryInsertService extends AbstractService implements
        IService<AgentAndProductApplicationHistoryInsertServiceReqBean, AgentAndProductApplicationHistoryInsertServiceResBean> {

    private ASSLogger logger = new ASSLogger();

    @Override
    public AgentAndProductApplicationHistoryInsertServiceResBean execute(
            AgentAndProductApplicationHistoryInsertServiceReqBean reqBean) {

        AgentAndProductApplicationHistoryInsertServiceResBean resBean =
                new AgentAndProductApplicationHistoryInsertServiceResBean();

        try {

            AgentAndProductApplicationHistoryInsertReqDto insertReqDto =
                    new AgentAndProductApplicationHistoryInsertReqDto();
