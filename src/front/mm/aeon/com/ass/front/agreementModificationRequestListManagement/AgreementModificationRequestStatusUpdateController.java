...
public class AgreementModificationRequestStatusUpdateController extends AbstractController implements
    ...
    public AgreementModificationRequestListFormBean process(AgreementModificationRequestListFormBean formBean) {
        ...
        // Agreement Modification Upload action
        ...
        updateServiceReqBean.setStatus(12);
        updateServiceReqBean.setModifyStatus(1);
        ...
        if (ServiceStatusCode.OK.equals(serviceStatus)) {
            ...
            if (ServiceStatusCode.OK.equals(serviceStatus)) {
                ...
                serviceReqBean.setModifyStatus(1);
