...
public class AgreementModificationRequestUnLockUpdateController extends AbstractController implements
    ...
    public AgreementModificationRequestListFormBean process(AgreementModificationRequestListFormBean formBean) {
        ...
        if (ServiceStatusCode.OK.equals(serviceStatus)) {
            applicationLogger.log("New application unlock update process finished.", LogLevel.INFO);
        } else {
    ...
    private AgreementModificationRequestListFormBean setErrorMessage(AgreementModificationRequestListFormBean formBean,
        ...
        if (ServiceStatusCode.RECORD_DUPLICATED_ERROR.equals(serviceStatus)) {
            ...
            applicationLogger.log("New application unlock update data already exist.", LogLevel.ERROR);
            ...
            applicationLogger.log(msgBean.getMessage(), LogLevel.ERROR);
            applicationLogger.log("New application unlock update data is locked.", LogLevel.ERROR);
            ...
            applicationLogger.log(msgBean.getMessage(), LogLevel.ERROR);
            applicationLogger.log("New application unlock update data already updated.", LogLevel.ERROR);
            ...
            applicationLogger.log(msgBean.getMessage(), LogLevel.ERROR);
            applicationLogger.log("New application unlock update data already deleted by other.", LogLevel.ERROR);
