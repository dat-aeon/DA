...
public class AgreementModificationRequestCancelStatusUpdateController extends AbstractController implements
    ...
    public AgreementModificationRequestListFormBean process(AgreementModificationRequestListFormBean formBean) {
        ...
        applicationLogger.log("New application cancel status update process started.", LogLevel.INFO);
        ...
        if (InputChecker.isBlankOrNull(formBean.getHeaderBean().getModifyComment())) {
        ...
        updateServiceReqBean.setStatus(10);
        updateServiceReqBean.setModifyStatus(0);
        updateServiceReqBean.setModifyComment(formBean.getHeaderBean().getModifyComment());
        ...
        if (ServiceStatusCode.OK.equals(serviceStatus)) {
            ...
            if (ServiceStatusCode.OK.equals(serviceStatus)) {
                ...
                applicationLogger.log("New application cancel status update insert into process started.",
                        LogLevel.INFO);
                ...
                serviceReqBean.setModifyComment(formBean.getHeaderBean().getModifyComment());
                serviceReqBean.setModifyStatus(0);
                ...
                if (ServiceStatusCode.OK.equals(serviceStatus)) {
                    ...
                    applicationLogger.log("New application cancel status update process finished.", LogLevel.INFO);
                } else {
    ...
    private AgreementModificationRequestListFormBean setErrorMessage(AgreementModificationRequestListFormBean formBean,
        ...
        if (ServiceStatusCode.RECORD_DUPLICATED_ERROR.equals(serviceStatus)) {
            ...
            applicationLogger.log("New application cancel status update data already exist.", LogLevel.ERROR);
            ...
            applicationLogger.log(msgBean.getMessage(), LogLevel.ERROR);
            applicationLogger.log("New application cancel status update data is locked.", LogLevel.ERROR);
            ...
            applicationLogger.log(msgBean.getMessage(), LogLevel.ERROR);
            applicationLogger.log("New application cancel status update data already updated.", LogLevel.ERROR);
            ...
            applicationLogger.log(msgBean.getMessage(), LogLevel.ERROR);
            applicationLogger.log("New application cancel status update data already deleted by other.",
                    LogLevel.ERROR);
