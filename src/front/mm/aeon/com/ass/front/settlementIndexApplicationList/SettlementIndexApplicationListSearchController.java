...
import mm.aeon.com.ass.base.dto.settlementIndexApplicationListSearch.SettlementIndexApplicationSelectCountReqDto;
...
public class SettlementIndexApplicationListSearchController extends AbstractController
    ...
    public SettlementIndexApplicationListFormBean process(SettlementIndexApplicationListFormBean formBean) {
        ...
        applicationLogger.log("Settlement Index Application Searching Process started.", LogLevel.INFO);
        ...
        try {
            ...
            SettlementIndexApplicationSelectCountReqDto countReqDto = new SettlementIndexApplicationSelectCountReqDto();
            SettlementIndexApplicationSearchReqDto reqDto = new SettlementIndexApplicationSearchReqDto();
            SettlementIndexApplicationListHeaderBean formBeanSearchHeaderBean = formBean.getSearchHeaderBean();
            ...
            formBean.setSettlementIndexApplicationSearchReqDto(reqDto);
