...
import mm.aeon.com.ass.base.dto.settlementIndexApplicationListSearch.SettlementIndexApplicationSearchResDto;
...
public class SettlementIndexApplicationListPaginationController
        extends LazyDataModel<SettlementIndexApplicationListLineBean> {
    ...
    private SettlementIndexApplicationSearchReqDto appSearchReqDto;

    private ApplicationLogger applicationLogger = new ApplicationLogger();

    public SettlementIndexApplicationListPaginationController(int rowCount,
            SettlementIndexApplicationSearchReqDto appSearchReqDto) {
        this.rowCount = rowCount;
        this.appSearchReqDto = appSearchReqDto;
    }

    @Override
    public Object getRowKey(SettlementIndexApplicationListLineBean appListLineBean) {
    ...
    @Override
    public List<SettlementIndexApplicationListLineBean> load(int first, int pageSize, String sortField,
        ...
        List<SettlementIndexApplicationListLineBean> lineBeanList =
                new ArrayList<SettlementIndexApplicationListLineBean>();
        try {
            List<SettlementIndexApplicationSearchResDto> resApplicationList =
                    (List<SettlementIndexApplicationSearchResDto>) CommonUtil.getDaoServiceInvoker()
                            .execute(appSearchReqDto);
            UserInfoReferReqDto userInfoReferReqDto;
            UserInfoReferResDto userInfoReferResDto;
            String[] str;
            for (SettlementIndexApplicationSearchResDto resdto : resApplicationList) {
                SettlementIndexApplicationListLineBean lineBean = new SettlementIndexApplicationListLineBean();
