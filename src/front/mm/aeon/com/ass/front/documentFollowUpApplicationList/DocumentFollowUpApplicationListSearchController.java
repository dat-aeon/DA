...
public class DocumentFollowUpApplicationListSearchController extends AbstractController implements
    ...
    public DocumentFollowUpApplicationListFormBean process(DocumentFollowUpApplicationListFormBean formBean) {
        ...
        try {
            ...
            DocumentFollowUpApplicationSelectCountReqDto countReqDto =
                    new DocumentFollowUpApplicationSelectCountReqDto();
            DocumentFollowUpApplicationSearchReqDto reqDto = new DocumentFollowUpApplicationSearchReqDto();
            DocumentFollowUpApplicationListHeaderBean formBeanSearchHeaderBean = formBean.getSearchHeaderBean();
            ...
            formBean.setDocumentFollowUpApplicationSearchReqDto(reqDto);
    ...
    private boolean isValidData(DocumentFollowUpApplicationListFormBean formBean) {
