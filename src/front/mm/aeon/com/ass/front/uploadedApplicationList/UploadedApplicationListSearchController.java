...
public class UploadedApplicationListSearchController extends AbstractController
    ...
    public UploadedApplicationListFormBean process(UploadedApplicationListFormBean formBean) {
        ...
        UploadedApplicationSearchReqDto reqDto = new UploadedApplicationSearchReqDto();
        UploadedApplicationListHeaderBean formBeanSearchHeaderBean = formBean.getSearchHeaderBean();
        ...
        if (formBeanSearchHeaderBean.getUploadedApplicationFrom() != null) {
            countReqDto.setUploadedApplicationFrom(formBeanSearchHeaderBean.getUploadedApplicationFrom());
        }
        if (formBeanSearchHeaderBean.getUploadedApplicationTo() != null) {
            countReqDto.setUploadedApplicationTo(formBeanSearchHeaderBean.getUploadedApplicationTo());
        }
        if (formBeanSearchHeaderBean.getFinalJudgementDateFrom() != null) {
            countReqDto.setFinalJudgementDateFrom(formBeanSearchHeaderBean.getFinalJudgementDateFrom());
        }
        if (formBeanSearchHeaderBean.getFinalJudgementDateTo() != null) {
            countReqDto.setFinalJudgementDateTo(formBeanSearchHeaderBean.getFinalJudgementDateTo());
        }
        ...
        if (formBeanSearchHeaderBean.getUploadedApplicationFrom() != null) {
            reqDto.setUploadedApplicationFrom(formBeanSearchHeaderBean.getUploadedApplicationFrom());
        }
        if (formBeanSearchHeaderBean.getUploadedApplicationTo() != null) {
            reqDto.setUploadedApplicationTo(formBeanSearchHeaderBean.getUploadedApplicationTo());
        }
        if (formBeanSearchHeaderBean.getFinalJudgementDateFrom() != null) {
            reqDto.setFinalJudgementDateFrom(formBeanSearchHeaderBean.getFinalJudgementDateFrom());
        }
        if (formBeanSearchHeaderBean.getFinalJudgementDateTo() != null) {
            reqDto.setFinalJudgementDateTo(formBeanSearchHeaderBean.getFinalJudgementDateTo());
        }

        try {
            int totalCount = (Integer) CommonUtil.getDaoServiceInvoker().execute(countReqDto);
            formBean.setTotalCount(totalCount);
            formBean.setUploadedApplicationSearchReqDto(reqDto);
