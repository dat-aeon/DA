...
import mm.aeon.com.ass.base.dto.newApplicationListSearch.NewApplicationApplicantCompanySearchResDto;
import mm.aeon.com.ass.base.dto.newApplicationListSearch.NewApplicationAttachmentSearchResDto;
import mm.aeon.com.ass.base.dto.newApplicationListSearch.NewApplicationEmergencyContactSearchResDto;
import mm.aeon.com.ass.base.dto.newApplicationListSearch.NewApplicationGuarantorSearchResDto;

public class NewApplicationListLineBean implements Serializable {
    ...
    private NewApplicationApplicantCompanySearchResDto applicantCompanyDto;

    private NewApplicationEmergencyContactSearchResDto emergencyContactDto;

    private NewApplicationGuarantorSearchResDto guarantorDto;

    List<NewApplicationAttachmentSearchResDto> attachmentDtoList;
    ...
    public NewApplicationApplicantCompanySearchResDto getApplicantCompanyDto() {
        return applicantCompanyDto;
    }

    public void setApplicantCompanyDto(NewApplicationApplicantCompanySearchResDto applicantCompanyDto) {
        this.applicantCompanyDto = applicantCompanyDto;
    }

    public NewApplicationEmergencyContactSearchResDto getEmergencyContactDto() {
        return emergencyContactDto;
    }

    public void setEmergencyContactDto(NewApplicationEmergencyContactSearchResDto emergencyContactDto) {
        this.emergencyContactDto = emergencyContactDto;
    }

    public NewApplicationGuarantorSearchResDto getGuarantorDto() {
        return guarantorDto;
    }

    public void setGuarantorDto(NewApplicationGuarantorSearchResDto guarantorDto) {
        this.guarantorDto = guarantorDto;
    }

    public List<NewApplicationAttachmentSearchResDto> getAttachmentDtoList() {
        return attachmentDtoList;
    }

    public void setAttachmentDtoList(List<NewApplicationAttachmentSearchResDto> attachmentDtoList) {
