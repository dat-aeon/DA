...
public class AgreementModificationRequestListSearchController extends AbstractController implements
    ...
    public AgreementModificationRequestListFormBean process(AgreementModificationRequestListFormBean formBean) {
        ...
        AgreementModificationRequestSelectCountReqDto countReqDto = new AgreementModificationRequestSelectCountReqDto();
        AgreementModificationRequestSearchReqDto reqDto = new AgreementModificationRequestSearchReqDto();
        AgreementModificationRequestListHeaderBean formBeanSearchHeaderBean = formBean.getSearchHeaderBean();
        ...
        try {
            ...
            formBean.setAgreementModificationRequestSearchReqDto(reqDto);
