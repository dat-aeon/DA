...
import mm.aeon.com.ass.base.dto.agreementModificationRequestListSearch.AgreementModificationRequestApplicantCompanySearchResDto;
...
import mm.aeon.com.ass.base.dto.agreementModificationRequestListSearch.AgreementModificationRequestEmergencyContactSearchResDto;
import mm.aeon.com.ass.base.dto.agreementModificationRequestListSearch.AgreementModificationRequestGuarantorSearchResDto;
import mm.aeon.com.ass.base.dto.agreementModificationRequestListSearch.AgreementModificationRequestPurchaseInfoSearchResDto;

public class AgreementModificationRequestListLineBean implements Serializable {
    ...
    private AgreementModificationRequestApplicantCompanySearchResDto applicantCompanyDto;

    private AgreementModificationRequestEmergencyContactSearchResDto emergencyContactDto;

    private AgreementModificationRequestGuarantorSearchResDto guarantorDto;

    private List<AgreementModificationRequestAttachmentSearchResDto> attachmentDtoList;

    private AgreementModificationRequestPurchaseInfoSearchResDto purchaseDto;
    ...
    public AgreementModificationRequestApplicantCompanySearchResDto getApplicantCompanyDto() {
        return applicantCompanyDto;
    }

    public AgreementModificationRequestEmergencyContactSearchResDto getEmergencyContactDto() {
        return emergencyContactDto;
    }

    public AgreementModificationRequestGuarantorSearchResDto getGuarantorDto() {
        return guarantorDto;
    }

    public void setApplicantCompanyDto(AgreementModificationRequestApplicantCompanySearchResDto applicantCompanyDto) {
        this.applicantCompanyDto = applicantCompanyDto;
    }

    public void setEmergencyContactDto(AgreementModificationRequestEmergencyContactSearchResDto emergencyContactDto) {
        this.emergencyContactDto = emergencyContactDto;
    }

    public void setGuarantorDto(AgreementModificationRequestGuarantorSearchResDto guarantorDto) {
        this.guarantorDto = guarantorDto;
    }

    public List<AgreementModificationRequestAttachmentSearchResDto> getAttachmentDtoList() {
        return attachmentDtoList;
    }

    public void setAttachmentDtoList(List<AgreementModificationRequestAttachmentSearchResDto> attachmentDtoList) {
    ...
    public AgreementModificationRequestPurchaseInfoSearchResDto getPurchaseDto() {
        return purchaseDto;
    }

    public void setPurchaseDto(AgreementModificationRequestPurchaseInfoSearchResDto purchaseDto) {
