...
public class SaleClaimApplicationUnLockUpdateController extends AbstractController
    ...
    public SaleClaimApplicationListFormBean process(SaleClaimApplicationListFormBean formBean) {
        ...
        if (ServiceStatusCode.OK.equals(serviceStatus)) {
            applicationLogger.log("Sale Claim application unlock update process finished.", LogLevel.INFO);
        } else {
    ...
    private SaleClaimApplicationListFormBean setErrorMessage(SaleClaimApplicationListFormBean formBean,
        ...
        if (ServiceStatusCode.RECORD_DUPLICATED_ERROR.equals(serviceStatus)) {
            ...
            applicationLogger.log("Sale Claim application unlock update data already exist.", LogLevel.ERROR);
            ...
            applicationLogger.log(msgBean.getMessage(), LogLevel.ERROR);
            applicationLogger.log("Sale Claim application unlock update data is locked.", LogLevel.ERROR);
            ...
            applicationLogger.log(msgBean.getMessage(), LogLevel.ERROR);
            applicationLogger.log("Sale Claim application unlock update data already updated.", LogLevel.ERROR);
            ...
            applicationLogger.log(msgBean.getMessage(), LogLevel.ERROR);
            applicationLogger.log("Sale Claim application unlock update data already deleted by other.",
                    LogLevel.ERROR);
