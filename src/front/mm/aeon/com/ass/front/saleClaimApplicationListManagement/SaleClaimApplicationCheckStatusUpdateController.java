...
public class SaleClaimApplicationCheckStatusUpdateController extends AbstractController
    ...
    public SaleClaimApplicationListFormBean process(SaleClaimApplicationListFormBean formBean) {
        ...
        SaleClaimApplicationStatusUpdateReqBean updateServiceReqBean = new SaleClaimApplicationStatusUpdateReqBean();
        updateServiceReqBean.setDa_application_info_id(formBean.getLineBean().getApplicationId());
        updateServiceReqBean.setStatus(20);
        ...
        if (ServiceStatusCode.OK.equals(serviceStatus)) {
            ...
            if (ServiceStatusCode.OK.equals(serviceStatus)) {
                ...
                applicationLogger.log("Sale Claim application check status update insert into history Process started.",
                        LogLevel.INFO);
