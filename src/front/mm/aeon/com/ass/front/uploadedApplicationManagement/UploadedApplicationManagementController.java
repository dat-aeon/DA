 ...
 *************************************************************************/
package mm.aeon.com.ass.front.uploadedApplicationManagement;
...
public class UploadedApplicationManagementController extends AbstractController
        implements IControllerAccessor<UploadedApplicationListFormBean, UploadedApplicationListFormBean> {

    private ApplicationLogger applicationLogger = new ApplicationLogger();

    @Override
    public UploadedApplicationListFormBean process(UploadedApplicationListFormBean formBean) {

        MessageBean msgBean;
        formBean.getMessageContainer().clearAllMessages(true);

        applicationLogger.log("Uploaded application update process started.", LogLevel.INFO);
        ...
        if (!formBean.getNrcFrontEditFlag() && !formBean.getNrcBackEditFlag() && !formBean.getResidentProofEditFlag()
            ...
            applicationLogger.log("Uploaded application edit flag is false.", LogLevel.ERROR);
        } else {
            ...
            if (ServiceStatusCode.OK.equals(serviceStatus)) {
                ...
                List<UploadedApplicationAttachmentSearchResDto> attachmentresDto =
                        new ArrayList<UploadedApplicationAttachmentSearchResDto>();
                attachmentresDto = formBean.getLineBean().getAttachmentDtoList();
                for (UploadedApplicationAttachmentSearchResDto resDto : attachmentresDto) {
                    ...
                    if (resDto.getFileType() == DACommon.NRC_FRONT_ATTACHMENT) {
                        if (formBean.getNrcFrontEditFlag()) {
                ...
                if (ServiceStatusCode.OK.equals(serviceStatus)) {
                    ...
                    serviceReqBean.setSettlementPendingComment(formBean.getLineBean().getSettlement_comment());
                    ...
                    if (ServiceStatusCode.OK.equals(serviceStatus)) {
                        ...
                        if (ServiceStatusCode.OK.equals(serviceStatus)) {
                            ...
                            applicationLogger.log("Uploaded status Update Process finished.", LogLevel.INFO);
                        } else {
                            setErrorMessage(formBean, serviceStatus);
                        }
    ...
    private UploadedApplicationListFormBean setErrorMessage(UploadedApplicationListFormBean formBean,
        ...
        if (ServiceStatusCode.RECORD_DUPLICATED_ERROR.equals(serviceStatus)) {
            ...
            applicationLogger.log(msgBean.getMessage(), LogLevel.ERROR);
            applicationLogger.log("Uploaded application update data already exist.", LogLevel.ERROR);
            ...
            applicationLogger.log(msgBean.getMessage(), LogLevel.ERROR);
            applicationLogger.log("Uploaded application update data is locked.", LogLevel.ERROR);
            ...
            applicationLogger.log(msgBean.getMessage(), LogLevel.ERROR);
            applicationLogger.log("Uploaded application update data already updated.", LogLevel.ERROR);
            ...
            applicationLogger.log(msgBean.getMessage(), LogLevel.ERROR);
            applicationLogger.log("Uploaded application update data already deleted by other.", LogLevel.ERROR);
