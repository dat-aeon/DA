...
public class ItemLabelListLazySorter implements Comparator<ItemLabelListLineBean> {
    ...
    public ItemLabelListLazySorter(String sortField, SortOrder sortOrder) {
        this.sortOrder = sortOrder;
        this.sortField = sortField;
    }

    public int compare(ItemLabelListLineBean member1, ItemLabelListLineBean member2) {
