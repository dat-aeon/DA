 ...
 * </p>
 */
public class LoginController extends AbstractDAController implements IControllerAccessor<LoginFormBean, LoginFormBean> {
    ...
    public LoginFormBean process(LoginFormBean loginFormBean) {
        ...
        try {
            ...
            if (loginInfoReferRes != null) {
                ...
                if (Integer.parseInt(loginInfoReferRes.getUserTypeId()) == VCSCommon.USER_TYPE_DA_OPERATOR_ID) {
                    loginFormBean.getLoginUserInfo().setDepartmentName(loginInfoReferRes.getDepartmentName());
                    loginFormBean.getLoginUserInfo().setOperatorDepartment(
                            loginInfoReferRes.getName() + "<br>" + loginInfoReferRes.getDepartmentName());
                }
                loginFormBean.getLoginUserInfo().setGroupId(loginInfoReferRes.getGroupId());
                ...
                if (loginFormBean.getLoginUserInfo().getGroupId() != null) {
                    super.loadMenu(loginFormBean.getLoginUserInfo());
                }
