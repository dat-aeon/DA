...
public class AdminListSearchController extends AbstractController
    ...
    public AdminListFormBean process(AdminListFormBean formBean) {
        ...
        formBean.setGroupSelectItemList(getGroupSelectList());
        if (formBean.getGroupSelectItemList().size() == 0) {
            msgBean = new MessageBean(MessageId.ME1006, "GROUP");
        ...
        reqDto.setUserTypeId(VCSCommon.USER_TYPE_DA_ADMIN_ID);
    ...
    private ArrayList<SelectItem> getGroupSelectList() {
