...
public class AgentAndProductApplicationFollowUpLockUpdateController extends AbstractController
    ...
    public AgentAndProductApplicationListFormBean process(AgentAndProductApplicationListFormBean formBean) {
        ...
        try {
            ...
            if (!resCheck.getLockFlag()
                ...
                // Lock start
                AgentAndProductApplicationInfoFollowUpLockUpdateServiceReqBean lockServiceReqBean =
