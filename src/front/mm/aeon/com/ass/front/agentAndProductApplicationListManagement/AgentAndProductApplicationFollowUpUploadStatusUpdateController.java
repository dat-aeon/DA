...
import mm.aeon.com.ass.base.dto.agentAndProductApplicationSelectForUpdate.AgentAndProductApplicationFlagSelectForUpdateReqDto;
import mm.aeon.com.ass.base.dto.agentAndProductApplicationSelectForUpdate.AgentAndProductApplicationFlagSelectForUpdateResDto;
import mm.aeon.com.ass.base.service.agentAndProductUpdateService.AgentAndProductApplicationInfoLockUpdateServiceReqBean;
import mm.aeon.com.ass.base.service.agentAndProductUpdateService.AgentAndProductApplicationStatusUpdateReqBean;
...
public class AgentAndProductApplicationFollowUpUploadStatusUpdateController extends AbstractController
    ...
    public AgentAndProductApplicationListFormBean process(AgentAndProductApplicationListFormBean formBean) {
        ...
        applicationLogger.log("Agent And Product application Follow Up Flag update process started.", LogLevel.INFO);
        AgentAndProductApplicationStatusUpdateReqBean flagUpdateServiceReqBean =
                new AgentAndProductApplicationStatusUpdateReqBean();
        flagUpdateServiceReqBean.setDa_application_info_id(formBean.getLineBean().getApplicationId());
        flagUpdateServiceReqBean.setFollowUpCompleteFlag(true);
        flagUpdateServiceReqBean.setUpdated_by(String.valueOf(userId) + "," + userTypeId);
        flagUpdateServiceReqBean.setUpdated_time(CommonUtil.getCurrentTimeStamp());

        this.getServiceInvoker().addRequest(flagUpdateServiceReqBean);
        ...
        if (ServiceStatusCode.OK.equals(serviceStatus)) {
            AgentAndProductApplicationFlagSelectForUpdateReqDto flagSelectReqDto =
                    new AgentAndProductApplicationFlagSelectForUpdateReqDto();
            flagSelectReqDto.setApplicationNo(formBean.getLineBean().getApplicationNo());
            flagSelectReqDto.setStatus(17);
            try {
                AgentAndProductApplicationFlagSelectForUpdateResDto selectForUpdateResDto =
                        (AgentAndProductApplicationFlagSelectForUpdateResDto) this.getDaoServiceInvoker()
                                .execute(flagSelectReqDto);
                ...
                if (selectForUpdateResDto == null) {
                    ...
                    applicationLogger.log("Agent And Product application upload status update process finished.",
                            LogLevel.INFO);
        ...
        if (changeStatus == true) {
            ...
            AgentAndProductApplicationStatusUpdateReqBean updateServiceReqBean =
                    new AgentAndProductApplicationStatusUpdateReqBean();
            ...
            if (ServiceStatusCode.OK.equals(serviceStatus)) {
                ...
                if (ServiceStatusCode.OK.equals(serviceStatus)) {
                    ...
                    applicationLogger.log(
                            "Agent And Product application upload status update insert into history Process started.",
                            LogLevel.INFO);
