...
import mm.aeon.com.ass.base.dto.agentAndProductApplicationListSearch.AgentAndProductApplicationSearchResDto;
...
public class AgentAndProductApplicationListPaginationController
        extends LazyDataModel<AgentAndProductApplicationListLineBean> {
    ...
    private AgentAndProductApplicationSearchReqDto appSearchReqDto;

    private ApplicationLogger applicationLogger = new ApplicationLogger();

    public AgentAndProductApplicationListPaginationController(int rowCount,
            AgentAndProductApplicationSearchReqDto appSearchReqDto) {
        this.rowCount = rowCount;
        this.appSearchReqDto = appSearchReqDto;
    }

    @Override
    public Object getRowKey(AgentAndProductApplicationListLineBean appListLineBean) {
    ...
    @Override
    public List<AgentAndProductApplicationListLineBean> load(int first, int pageSize, String sortField,
        ...
        List<AgentAndProductApplicationListLineBean> lineBeanList =
                new ArrayList<AgentAndProductApplicationListLineBean>();
        try {
            List<AgentAndProductApplicationSearchResDto> resApplicationList =
                    (List<AgentAndProductApplicationSearchResDto>) CommonUtil.getDaoServiceInvoker()
                            .execute(appSearchReqDto);
            UserInfoReferReqDto userInfoReferReqDto;
            UserInfoReferResDto userInfoReferResDto;
            String[] str;
            for (AgentAndProductApplicationSearchResDto resdto : resApplicationList) {
                AgentAndProductApplicationListLineBean lineBean = new AgentAndProductApplicationListLineBean();
                ...
                lineBean.setFollowUpLockFlag(resdto.getFollowUpLockFlag());
                lineBean.setFollowUpLockTime(resdto.getFollowUpLockTime());
                lineBean.setFollowUpLockBy(resdto.getFollowUpLockBy());
                lineBean.setFollowUpCompleteFlag(resdto.getFollowUpCompleteFlag());
                lineBean.setNotYetCompleteFlag(resdto.getNotYetCompleteFlag());
