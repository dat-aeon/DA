...
public class IndexApplicationStatusUpdateController extends AbstractController
    ...
    public IndexApplicationListFormBean process(IndexApplicationListFormBean formBean) {
        ...
        applicationLogger.log("Index finished status update process started.", LogLevel.INFO);
        ...
        if (ServiceStatusCode.OK.equals(serviceStatus)) {
            ...
            if (ServiceStatusCode.OK.equals(serviceStatus)) {
                ...
                applicationLogger.log("Index application insert into history table process started.", LogLevel.INFO);
                ...
                if (ServiceStatusCode.OK.equals(serviceStatus)) {
                    ...
                    applicationLogger.log("Index application status update process finished.", LogLevel.INFO);
    ...
    private IndexApplicationListFormBean setErrorMessage(IndexApplicationListFormBean formBean, String serviceStatus) {
        ...
        if (ServiceStatusCode.RECORD_DUPLICATED_ERROR.equals(serviceStatus)) {
            ...
            applicationLogger.log("Index application status update data already exist.", LogLevel.ERROR);
            ...
            applicationLogger.log(msgBean.getMessage(), LogLevel.ERROR);
            applicationLogger.log("Index application status update data is locked.", LogLevel.ERROR);
            ...
            applicationLogger.log(msgBean.getMessage(), LogLevel.ERROR);
            applicationLogger.log("Index application status update data already updated.", LogLevel.ERROR);
            ...
            applicationLogger.log(msgBean.getMessage(), LogLevel.ERROR);
            applicationLogger.log("Index application status update data already deleted by other.", LogLevel.ERROR);
