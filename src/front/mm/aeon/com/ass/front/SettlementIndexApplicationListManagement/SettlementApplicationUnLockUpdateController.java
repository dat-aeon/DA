...
public class SettlementApplicationUnLockUpdateController extends AbstractController
    ...
    public SettlementIndexApplicationListFormBean process(SettlementIndexApplicationListFormBean formBean) {
        ...
        if (ServiceStatusCode.OK.equals(serviceStatus)) {
            applicationLogger.log("Settlement application unlock update process finished.", LogLevel.INFO);
        } else {
    ...
    private SettlementIndexApplicationListFormBean setErrorMessage(SettlementIndexApplicationListFormBean formBean,
        ...
        if (ServiceStatusCode.RECORD_DUPLICATED_ERROR.equals(serviceStatus)) {
            ...
            applicationLogger.log("Settlement application unlock update data already exist.", LogLevel.ERROR);
            ...
            applicationLogger.log(msgBean.getMessage(), LogLevel.ERROR);
            applicationLogger.log("Settlement application unlock update data is locked.", LogLevel.ERROR);
            ...
            applicationLogger.log(msgBean.getMessage(), LogLevel.ERROR);
            applicationLogger.log("Settlement application unlock update data already updated.", LogLevel.ERROR);
            ...
            applicationLogger.log(msgBean.getMessage(), LogLevel.ERROR);
            applicationLogger.log("Settlement application unlock update data already deleted by other.",
                    LogLevel.ERROR);
