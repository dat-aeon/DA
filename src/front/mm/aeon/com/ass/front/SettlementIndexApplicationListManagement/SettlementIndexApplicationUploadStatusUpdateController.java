...
import mm.aeon.com.ass.base.service.settlementIndexUpdateService.SettlementIndexApplicationInfoLockUpdateServiceReqBean;
...
public class SettlementIndexApplicationUploadStatusUpdateController extends AbstractController
    ...
    public SettlementIndexApplicationListFormBean process(SettlementIndexApplicationListFormBean formBean) {
        ...
        applicationLogger.log("Settlement application upload status update process started.", LogLevel.INFO);
        ...
        updateServiceReqBean.setStatus(16);
        ...
        if (ServiceStatusCode.OK.equals(serviceStatus)) {
            // unlock
            SettlementIndexApplicationInfoLockUpdateServiceReqBean unLockServiceReqBean =
                    new SettlementIndexApplicationInfoLockUpdateServiceReqBean();
            ...
            if (ServiceStatusCode.OK.equals(serviceStatus)) {
                ...
                applicationLogger.log(
                        "Settlement application upload status update insert into history Process started.",
                        LogLevel.INFO);
                ...
                if (ServiceStatusCode.OK.equals(serviceStatus)) {
                    ...
                    applicationLogger.log("Settlement application upload status update process finished.",
                            LogLevel.INFO);
                } else {
    ...
    private SettlementIndexApplicationListFormBean setErrorMessage(SettlementIndexApplicationListFormBean formBean,
        ...
        if (ServiceStatusCode.RECORD_DUPLICATED_ERROR.equals(serviceStatus)) {
            ...
            applicationLogger.log("Settlement application upload status update data already exist.", LogLevel.ERROR);
            ...
            applicationLogger.log(msgBean.getMessage(), LogLevel.ERROR);
            applicationLogger.log("Settlement application upload status update data is locked.", LogLevel.ERROR);
            ...
            applicationLogger.log(msgBean.getMessage(), LogLevel.ERROR);
            applicationLogger.log("Settlement application upload status update data already updated.", LogLevel.ERROR);
            ...
            applicationLogger.log(msgBean.getMessage(), LogLevel.ERROR);
            applicationLogger.log("Settlement application upload status update data already deleted by other.",
                    LogLevel.ERROR);
