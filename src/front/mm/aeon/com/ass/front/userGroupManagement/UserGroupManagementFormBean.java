...
@Name("userGroupManagementFormBean")
@Scope(ScopeType.CONVERSATION)
@FormBean
public class UserGroupManagementFormBean extends AbstractFormBean implements IRequest, IResponse {
    ...
    private UserGroupManagementHeaderBean registerHeaderBean;

    private UserGroupManagementHeaderBean backUpHeaderBean;
    ...
    @In(required = false, value = "lockParam")
    ...
    public void init() {
        ...
        registerHeaderBean = new UserGroupManagementHeaderBean();
    }
    ...
    public void updateInit() {
        ...
        this.registerHeaderBean.setGroupName(updateParam.getGroupName());
        this.registerHeaderBean.setUpdatedTime(updateParam.getUpdatedTime());

        this.backUpHeaderBean =
                new UserGroupManagementHeaderBean().copyUserGroupManagementHeaderBean(this.registerHeaderBean);
    }

    public void clear() {
        this.registerHeaderBean = new UserGroupManagementHeaderBean();
    }
    ...
    public void reset() {
        this.registerHeaderBean = registerHeaderBean.copyUserGroupManagementHeaderBean(backUpHeaderBean);
    }
    ...
    public UserGroupManagementHeaderBean getRegisterHeaderBean() {
        return registerHeaderBean;
    }

    public void setRegisterHeaderBean(UserGroupManagementHeaderBean registerHeaderBean) {
    ...
    public UserGroupManagementHeaderBean getBackUpHeaderBean() {
        return backUpHeaderBean;
    }

    public void setBackUpHeaderBean(UserGroupManagementHeaderBean backUpHeaderBean) {
