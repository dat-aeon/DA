...
import mm.aeon.com.ass.base.service.unpermitAttachmentUpdateService.UnpermitAttachmentUpdateServiceReqBean;
...
public class DocumentFollowUpApplicationUnpermitStatusUpdateController extends AbstractController implements
    ...
    public DocumentFollowUpApplicationListFormBean process(DocumentFollowUpApplicationListFormBean formBean) {
        ...
        appServiceStatus = resBean.getServiceStatus();

        if (ServiceStatusCode.OK.equals(appServiceStatus)) {
            UnpermitAttachmentUpdateServiceReqBean reqBean = new UnpermitAttachmentUpdateServiceReqBean();
            reqBean.setApplicationId(formBean.getLineBean().getApplicationId());
            ...
            setErrorMessage(formBean, appServiceStatus);
        }
