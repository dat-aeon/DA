...
public class DocumentFollowUpApplicationCheckStatusUpdateController extends AbstractController implements
    ...
    public DocumentFollowUpApplicationListFormBean process(DocumentFollowUpApplicationListFormBean formBean) {
        ...
        applicationLogger.log("Document follow up application check status update process started.", LogLevel.INFO);
        ...
        updateServiceReqBean.setStatus(7);
        ...
        if (ServiceStatusCode.OK.equals(serviceStatus)) {
            ...
            applicationLogger.log("Document follow up application check status update process finished.",
                    LogLevel.INFO);
            // unlock
            ...
            if (ServiceStatusCode.OK.equals(serviceStatus)) {
                ...
                applicationLogger.log(
                        "Document follow up application check status update insert into history process started.",
                        LogLevel.INFO);
    ...
    private DocumentFollowUpApplicationListFormBean setErrorMessage(DocumentFollowUpApplicationListFormBean formBean,
        ...
        if (ServiceStatusCode.RECORD_DUPLICATED_ERROR.equals(serviceStatus)) {
            ...
            applicationLogger.log("Document follow up application check status update data already exist.",
                    LogLevel.ERROR);
            ...
            applicationLogger.log(msgBean.getMessage(), LogLevel.ERROR);
            applicationLogger.log("Document follow up application check status update data is locked.", LogLevel.ERROR);
            ...
            applicationLogger.log(msgBean.getMessage(), LogLevel.ERROR);
            applicationLogger.log("Document follow up application check status update data already updated.",
                    LogLevel.ERROR);
            ...
            applicationLogger.log(msgBean.getMessage(), LogLevel.ERROR);
            applicationLogger.log("Document follow up application check status update data already checked by other.",
                    LogLevel.ERROR);
