...
public class DocumentFollowUpApplicationLockUpdateController extends AbstractController implements
        ...
        try {
            ...
            if (!resCheck.getLockFlag()
                ...
                if (ServiceStatusCode.OK.equals(serviceStatus)) {
                    ...
                    applicationLogger.log("Document follow up application lock update process finished.",
                            LogLevel.INFO);
                } else {
    ...
    private DocumentFollowUpApplicationListFormBean setErrorMessage(DocumentFollowUpApplicationListFormBean formBean,
        ...
        if (ServiceStatusCode.RECORD_DUPLICATED_ERROR.equals(serviceStatus)) {
            ...
            applicationLogger.log(msgBean.getMessage(), LogLevel.ERROR);
            applicationLogger.log("Document follow up application lock update data already exist.", LogLevel.ERROR);
            ...
            applicationLogger.log(msgBean.getMessage(), LogLevel.ERROR);
            applicationLogger.log("Document follow up application lock update data is locked.", LogLevel.ERROR);
            ...
            applicationLogger.log(msgBean.getMessage(), LogLevel.ERROR);
            applicationLogger.log("Document follow up application lock update data already updated.", LogLevel.ERROR);
            ...
            applicationLogger.log(msgBean.getMessage(), LogLevel.ERROR);
            applicationLogger.log("Document follow up application lock update data already deleted by other.",
                    LogLevel.ERROR);
