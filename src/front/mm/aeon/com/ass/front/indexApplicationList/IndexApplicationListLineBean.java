...
import mm.aeon.com.ass.base.dto.indexApplicationListSearch.IndexApplicationApplicantCompanySearchResDto;
import mm.aeon.com.ass.base.dto.indexApplicationListSearch.IndexApplicationAttachmentSearchResDto;
import mm.aeon.com.ass.base.dto.indexApplicationListSearch.IndexApplicationEmergencyContactSearchResDto;
import mm.aeon.com.ass.base.dto.indexApplicationListSearch.IndexApplicationGuarantorSearchResDto;

public class IndexApplicationListLineBean implements Serializable {
    ...
    private IndexApplicationApplicantCompanySearchResDto applicantCompanyDto;

    private IndexApplicationEmergencyContactSearchResDto emergencyContactDto;

    private IndexApplicationGuarantorSearchResDto guarantorDto;

    private List<IndexApplicationAttachmentSearchResDto> attachmentDtoList;
    ...
    public IndexApplicationApplicantCompanySearchResDto getApplicantCompanyDto() {
        return applicantCompanyDto;
    }

    public void setApplicantCompanyDto(IndexApplicationApplicantCompanySearchResDto applicantCompanyDto) {
        this.applicantCompanyDto = applicantCompanyDto;
    }

    public IndexApplicationEmergencyContactSearchResDto getEmergencyContactDto() {
        return emergencyContactDto;
    }

    public void setEmergencyContactDto(IndexApplicationEmergencyContactSearchResDto emergencyContactDto) {
        this.emergencyContactDto = emergencyContactDto;
    }

    public IndexApplicationGuarantorSearchResDto getGuarantorDto() {
        return guarantorDto;
    }

    public void setGuarantorDto(IndexApplicationGuarantorSearchResDto guarantorDto) {
        this.guarantorDto = guarantorDto;
    }

    public List<IndexApplicationAttachmentSearchResDto> getAttachmentDtoList() {
        return attachmentDtoList;
    }

    public void setAttachmentDtoList(List<IndexApplicationAttachmentSearchResDto> attachmentDtoList) {
    ...
    public Timestamp getIndexedTime() {
        return indexedTime;
    }

    public void setIndexedTime(Timestamp indexedTime) {
