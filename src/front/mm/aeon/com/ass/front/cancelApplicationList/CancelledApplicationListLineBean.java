...
import mm.aeon.com.ass.base.dto.cancelledApplicationListSearch.CancelledApplicationApplicantCompanySearchResDto;
import mm.aeon.com.ass.base.dto.cancelledApplicationListSearch.CancelledApplicationAttachmentSearchResDto;
import mm.aeon.com.ass.base.dto.cancelledApplicationListSearch.CancelledApplicationEmergencyContactSearchResDto;
import mm.aeon.com.ass.base.dto.cancelledApplicationListSearch.CancelledApplicationGuarantorSearchResDto;

public class CancelledApplicationListLineBean implements Serializable {
    ...
    private CancelledApplicationApplicantCompanySearchResDto applicantCompanyDto;

    private CancelledApplicationEmergencyContactSearchResDto emergencyContactDto;

    private CancelledApplicationGuarantorSearchResDto guarantorDto;

    private List<CancelledApplicationAttachmentSearchResDto> attachmentDtoList;
    ...
    public CancelledApplicationApplicantCompanySearchResDto getApplicantCompanyDto() {
        return applicantCompanyDto;
    }

    public void setApplicantCompanyDto(CancelledApplicationApplicantCompanySearchResDto applicantCompanyDto) {
        this.applicantCompanyDto = applicantCompanyDto;
    }

    public CancelledApplicationEmergencyContactSearchResDto getEmergencyContactDto() {
        return emergencyContactDto;
    }

    public void setEmergencyContactDto(CancelledApplicationEmergencyContactSearchResDto emergencyContactDto) {
        this.emergencyContactDto = emergencyContactDto;
    }

    public CancelledApplicationGuarantorSearchResDto getGuarantorDto() {
        return guarantorDto;
    }

    public void setGuarantorDto(CancelledApplicationGuarantorSearchResDto guarantorDto) {
        this.guarantorDto = guarantorDto;
    }

    public List<CancelledApplicationAttachmentSearchResDto> getAttachmentDtoList() {
        return attachmentDtoList;
    }

    public void setAttachmentDtoList(List<CancelledApplicationAttachmentSearchResDto> attachmentDtoList) {
