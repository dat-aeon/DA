...
import mm.aeon.com.ass.base.dto.applicationListSearch.ApplicationAttachmentSearchResDto;
...
public class ApplicationListFormBean extends AbstractFormBean implements IRequest, IResponse {
    ...
    private ApplicationListHeaderBean searchHeaderBean;
    ...
    private ArrayList<SelectItem> judgementStatusSelectItemList;

    private ArrayList<SelectItem> judgementStatusSearchSelectItemList;
    ...
    public void init() {
        ...
        Boolean result = CommonUtil.validateUrlAccess(CommonMenu.ALL_APPLICATIONS);
        if (result == false) {
        ...
        searchHeaderBean = new ApplicationListHeaderBean();
    ...
    public String search() {
        ...
        if (!this.getMessageContainer().checkMessage(MessageType.ERROR) && totalCount != 0) {
            lazyModel = new ApplicationListPaginationController(totalCount, applicationSearchReqDto);
        }
    ...
    public String detail(ApplicationListLineBean lineBean) {
        this.getMessageContainer().clearAllMessages(true);

        for (ApplicationAttachmentSearchResDto resFileDto : lineBean.getAttachmentDtoList()) {
            if (resFileDto.getFileType() == DACommon.NRC_FRONT_ATTACHMENT) {
                if (!StringUtils.isEmpty(resFileDto.getFilePath())) {
                    ...
                    File destinationFile = new File(FileHandler.getSystemPath() + "/temp"
                            + CommonUtil.getAttachmentInfoUploadImageFolder() + resFileDto.getFilePath());
                    ...
                    lineBean.setNrcFrontImageFilePath(
                            "/temp" + CommonUtil.getAttachmentInfoUploadImageFolder() + resFileDto.getFilePath());
                }
            }
            ...
            if (resFileDto.getFileType() == DACommon.NRC_BACK_ATTACHMENT) {
                if (!StringUtils.isEmpty(resFileDto.getFilePath())) {
                    ...
                    lineBean.setNrcBackImageFilePath(
                            "/temp" + CommonUtil.getAttachmentInfoUploadImageFolder() + resFileDto.getFilePath());
                }
            }
            ...
            if (resFileDto.getFileType() == DACommon.RESIDENT_PROOF_ATTACHMENT) {
                if (!StringUtils.isEmpty(resFileDto.getFilePath())) {
                    ...
                    lineBean.setResidentProofImageFilePath(
                            "/temp" + CommonUtil.getAttachmentInfoUploadImageFolder() + resFileDto.getFilePath());
                }
            }
            ...
            if (resFileDto.getFileType() == DACommon.INCOME_PROOF_ATTACHMENT) {
                if (!StringUtils.isEmpty(resFileDto.getFilePath())) {
                    ...
                    lineBean.setIncomeProofImageFilePath(
                            "/temp" + CommonUtil.getAttachmentInfoUploadImageFolder() + resFileDto.getFilePath());
                }
            }
            ...
            if (resFileDto.getFileType() == DACommon.GUARANTOR_NRC_FRONT_ATTACHMENT) {
                if (!StringUtils.isEmpty(resFileDto.getFilePath())) {
                    ...
                    lineBean.setGuarantorNrcFrontImageFilePath(
                            "/temp" + CommonUtil.getAttachmentInfoUploadImageFolder() + resFileDto.getFilePath());
                }
            }
            ...
            if (resFileDto.getFileType() == DACommon.GUARANTOR_NRC_BACK_ATTACHMENT) {
                if (!StringUtils.isEmpty(resFileDto.getFilePath())) {
                    ...
                    lineBean.setGuarantorNrcBackImageFilePath(
                            "/temp" + CommonUtil.getAttachmentInfoUploadImageFolder() + resFileDto.getFilePath());
                }
            }
            ...
            if (resFileDto.getFileType() == DACommon.HOUSEHOLD_OR_CRIMINAL_CLEARANCE_ATTACHMENT) {
                if (!StringUtils.isEmpty(resFileDto.getFilePath())) {
                    ...
                    lineBean.setHouseholdCriminalImageFilePath(
                            "/temp" + CommonUtil.getAttachmentInfoUploadImageFolder() + resFileDto.getFilePath());
                }
            }
            ...
            if (resFileDto.getFileType() == DACommon.APPLICANT_PHOTO_ATTACHMENT) {
                if (!StringUtils.isEmpty(resFileDto.getFilePath())) {
                    ...
                    lineBean.setApplicantPhotoImageFilePath(
                            "/temp" + CommonUtil.getAttachmentInfoUploadImageFolder() + resFileDto.getFilePath());
                }
            }
            ...
            if (resFileDto.getFileType() == DACommon.SIGNATURE_ATTACHMENT) {
                if (!StringUtils.isEmpty(resFileDto.getFilePath())) {
                    ...
                    lineBean.setSignatureImageFilePath(
                            "/temp" + CommonUtil.getAttachmentInfoUploadImageFolder() + resFileDto.getFilePath());
                }
            }
            ...
            if (resFileDto.getFileType() == DACommon.GUARANTOR_SIGNATURE_ATTACHMENT) {
                if (!StringUtils.isEmpty(resFileDto.getFilePath())) {
                    ...
                    lineBean.setGuarantorSignatureImageFilePath(
                            "/temp" + CommonUtil.getAttachmentInfoUploadImageFolder() + resFileDto.getFilePath());
                }
            }
        }
    ...
    public void reset() {
        this.searchHeaderBean = new ApplicationListHeaderBean();
    }
    ...
    public ApplicationListHeaderBean getSearchHeaderBean() {
        return searchHeaderBean;
    }

    public void setSearchHeaderBean(ApplicationListHeaderBean searchHeaderBean) {
    ...
    public ArrayList<SelectItem> getJudgementStatusSelectItemList() {
        return judgementStatusSelectItemList;
    }

    public void setJudgementStatusSelectItemList(ArrayList<SelectItem> judgementStatusSelectItemList) {
    ...
    public ArrayList<SelectItem> getJudgementStatusSearchSelectItemList() {
        return judgementStatusSearchSelectItemList;
    }

    public void setJudgementStatusSearchSelectItemList(ArrayList<SelectItem> judgementStatusSearchSelectItemList) {
        this.judgementStatusSearchSelectItemList = judgementStatusSearchSelectItemList;
    }
