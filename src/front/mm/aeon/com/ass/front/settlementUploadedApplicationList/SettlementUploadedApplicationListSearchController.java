...
import mm.aeon.com.ass.base.dto.settlementUploadedApplicationListSearch.SettlementUploadedApplicationSelectCountReqDto;
...
public class SettlementUploadedApplicationListSearchController extends AbstractController implements
        IControllerAccessor<SettlementUploadedApplicationListFormBean, SettlementUploadedApplicationListFormBean> {
    ...
    @Override
    public SettlementUploadedApplicationListFormBean process(SettlementUploadedApplicationListFormBean formBean) {
        ...
        try {
            ...
            SettlementUploadedApplicationSelectCountReqDto countReqDto =
                    new SettlementUploadedApplicationSelectCountReqDto();
            SettlementUploadedApplicationSearchReqDto reqDto = new SettlementUploadedApplicationSearchReqDto();
            SettlementUploadedApplicationListHeaderBean formBeanSearchHeaderBean = formBean.getSearchHeaderBean();
            ...
            formBean.setSettlementUploadedApplicationSearchReqDto(reqDto);
    ...
    private boolean isValidData(SettlementUploadedApplicationListFormBean formBean) {
