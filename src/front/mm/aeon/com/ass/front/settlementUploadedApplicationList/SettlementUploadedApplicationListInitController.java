...
public class SettlementUploadedApplicationListInitController extends AbstractDAController implements
    ...
    public SettlementUploadedApplicationListFormBean process(SettlementUploadedApplicationListFormBean formBean) {
        ...
        formBean.setSettlementUploadedTypeSelectItemList(super.getSettlementUploadedStatusSelectList());
        if (formBean.getSettlementUploadedTypeSelectItemList().size() == 0) {
