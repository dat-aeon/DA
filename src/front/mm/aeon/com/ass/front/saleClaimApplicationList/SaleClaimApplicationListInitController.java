...
public class SaleClaimApplicationListInitController extends AbstractDAController
    ...
    public SaleClaimApplicationListFormBean process(SaleClaimApplicationListFormBean formBean) {
        ...
        applicationLogger.log("Sale Claim Init process stared.", LogLevel.INFO);
        ...
        formBean.setPurchaseFileSelectItemList(super.getPurchaseFileTypeSelectList());
        if (formBean.getPurchaseFileSelectItemList().size() == 0) {
            messageBean = new MessageBean(MessageId.ME1006, "GROUP");
            messageBean.setMessageType(MessageType.ERROR);
            formBean.getMessageContainer().addMessage(messageBean);
            applicationLogger.log(messageBean.getMessage(), LogLevel.INFO);
        ...
        applicationLogger.log("Sale Claim Init process ended.", LogLevel.INFO);
        return formBean;
    }
