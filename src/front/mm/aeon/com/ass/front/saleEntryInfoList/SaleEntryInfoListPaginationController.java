...
import mm.aeon.com.ass.base.dto.saleEntryInfoListSearch.SaleEntryInfoApplicationSearchResDto;
...
public class SaleEntryInfoListPaginationController extends LazyDataModel<SaleEntryInfoListLineBean> {
    ...
    private SaleEntryInfoApplicationSearchReqDto appSearchReqDto;

    private ApplicationLogger applicationLogger = new ApplicationLogger();

    public SaleEntryInfoListPaginationController(int rowCount, SaleEntryInfoApplicationSearchReqDto appSearchReqDto) {
        this.rowCount = rowCount;
        this.appSearchReqDto = appSearchReqDto;
    }

    @Override
    public Object getRowKey(SaleEntryInfoListLineBean appListLineBean) {
    ...
    @Override
    public List<SaleEntryInfoListLineBean> load(int first, int pageSize, String sortField, SortOrder sortOrder,
            Map<String, Object> filters) {

        applicationLogger.log("Sale Entry info search pagination process started.", LogLevel.INFO);
        ...
        List<SaleEntryInfoListLineBean> lineBeanList = new ArrayList<SaleEntryInfoListLineBean>();
        try {
            List<SaleEntryInfoApplicationSearchResDto> resApplicationList =
                    (List<SaleEntryInfoApplicationSearchResDto>) CommonUtil.getDaoServiceInvoker()
                            .execute(appSearchReqDto);
            UserInfoReferReqDto userInfoReferReqDto;
            UserInfoReferResDto userInfoReferResDto;
            String[] str;
            for (SaleEntryInfoApplicationSearchResDto resdto : resApplicationList) {
                SaleEntryInfoListLineBean lineBean = new SaleEntryInfoListLineBean();
                ...
                lineBean.setSaleEntryCheckFlag(resdto.getSaleEntryCheckFlag());
