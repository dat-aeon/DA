...
import mm.aeon.com.ass.base.dto.agreementModificationUploadListSearch.AgreementModificationUploadApplicantCompanySearchResDto;
import mm.aeon.com.ass.base.dto.agreementModificationUploadListSearch.AgreementModificationUploadAttachmentSearchResDto;
import mm.aeon.com.ass.base.dto.agreementModificationUploadListSearch.AgreementModificationUploadEmergencyContactSearchResDto;
import mm.aeon.com.ass.base.dto.agreementModificationUploadListSearch.AgreementModificationUploadGuarantorSearchResDto;

public class AgreementModificationUploadListLineBean implements Serializable {
    ...
    private List<AgreementModificationUploadedTimeBean> uploadedTimeList;
    ...
    private AgreementModificationUploadApplicantCompanySearchResDto applicantCompanyDto;

    private AgreementModificationUploadEmergencyContactSearchResDto emergencyContactDto;

    private AgreementModificationUploadGuarantorSearchResDto guarantorDto;

    private List<AgreementModificationUploadAttachmentSearchResDto> attachmentDtoList;
    ...
    public void setSettlementComment(String settlementComment) {
        this.settlementComment = settlementComment;
    }
    ...
    public AgreementModificationUploadApplicantCompanySearchResDto getApplicantCompanyDto() {
        return applicantCompanyDto;
    }

    public AgreementModificationUploadEmergencyContactSearchResDto getEmergencyContactDto() {
        return emergencyContactDto;
    }

    public AgreementModificationUploadGuarantorSearchResDto getGuarantorDto() {
        return guarantorDto;
    }

    public void setApplicantCompanyDto(AgreementModificationUploadApplicantCompanySearchResDto applicantCompanyDto) {
        this.applicantCompanyDto = applicantCompanyDto;
    }

    public void setEmergencyContactDto(AgreementModificationUploadEmergencyContactSearchResDto emergencyContactDto) {
        this.emergencyContactDto = emergencyContactDto;
    }

    public void setGuarantorDto(AgreementModificationUploadGuarantorSearchResDto guarantorDto) {
        this.guarantorDto = guarantorDto;
    }

    public List<AgreementModificationUploadAttachmentSearchResDto> getAttachmentDtoList() {
        return attachmentDtoList;
    }

    public void setAttachmentDtoList(List<AgreementModificationUploadAttachmentSearchResDto> attachmentDtoList) {
    ...
    public List<AgreementModificationUploadedTimeBean> getUploadedTimeList() {
        return uploadedTimeList;
    }

    public void setUploadedTimeList(List<AgreementModificationUploadedTimeBean> uploadedTimeList) {
        this.uploadedTimeList = uploadedTimeList;
    }
