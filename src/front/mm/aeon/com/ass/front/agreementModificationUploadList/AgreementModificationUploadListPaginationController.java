...
import mm.aeon.com.ass.base.dto.agreementModificationUploadListSearch.AgreementModificationUploadSearchResDto;
...
public class AgreementModificationUploadListPaginationController
        extends LazyDataModel<AgreementModificationUploadListLineBean> {

    private static final long serialVersionUID = 2895710328228440321L;

    private int rowCount;

    private AgreementModificationUploadSearchReqDto agreementModificationSearchReqDto;

    private ApplicationLogger applicationLogger = new ApplicationLogger();

    public AgreementModificationUploadListPaginationController(int rowCount,
            AgreementModificationUploadSearchReqDto agreementModificationSearchReqDto) {
        this.rowCount = rowCount;
        this.agreementModificationSearchReqDto = agreementModificationSearchReqDto;
    }

    @Override
    public Object getRowKey(AgreementModificationUploadListLineBean appListLineBean) {
    ...
    @Override
    public List<AgreementModificationUploadListLineBean> load(int first, int pageSize, String sortField,
        ...
        List<AgreementModificationUploadListLineBean> lineBeanList =
                new ArrayList<AgreementModificationUploadListLineBean>();
        try {
            List<AgreementModificationUploadSearchResDto> resApplicationList =
                    (List<AgreementModificationUploadSearchResDto>) CommonUtil.getDaoServiceInvoker()
                            .execute(agreementModificationSearchReqDto);

            for (AgreementModificationUploadSearchResDto resdto : resApplicationList) {
                AgreementModificationUploadListLineBean lineBean = new AgreementModificationUploadListLineBean();
                ...
                documentErrorReqDto.setApplicationNo(resdto.getApplicationNo());
                documentErrorReqDto.setStatus(11);
                ...
                List<AgreementModificationUploadedTimeBean> uploadedTimeList =
                        new ArrayList<AgreementModificationUploadedTimeBean>();
                for (AgentDocumentErrorStaffCommentSearchResDto staffRes : documentErrorResList) {
                    AgreementModificationUploadedTimeBean uploadedTime = new AgreementModificationUploadedTimeBean();
                    uploadedTime.setCreatedTime(staffRes.getCreatedTime());

                    uploadedTimeList.add(uploadedTime);
                }
                lineBean.setUploadedTimeList(uploadedTimeList);
